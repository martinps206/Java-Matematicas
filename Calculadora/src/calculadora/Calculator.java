...
public class Calculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        resultado.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        if (this.operadorA==""){
            ...
            this.operadorB = this.operadorA;
            this.operadorA = "+";
            
            this.segundoNumero = Float.parseFloat(this.resultado.getText());
        
        switch (this.operadorB) {
            case "+":
                this.resultado.setText(retornarEntero(this.primerNumero + segundoNumero));
                this.primerNumero = Float.parseFloat(this.resultado.getText());
                break;
            case "-":
                this.resultado.setText(retornarEntero(this.primerNumero - segundoNumero));
    ...
    public String retornarEntero(float res) {
        String resultado = "";
